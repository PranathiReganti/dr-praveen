...
router.post('/next', authMiddleware, callNextPatient)           // Move queue forward (Admin Dashboard)
...
router.patch('/complete/:tokenNumber', authMiddleware, completeConsultationByTokenNumber)
// Legacy body-based completion (kept for compatibility)
router.patch('/complete-body', authMiddleware, completeConsultationByTokenNumber)
